...
AI Outfitter is a set of composable projects, not one monolith. Start with
[Outfitter](/docs/outfitter/documentation/getting-started/) to make agent
configuration reviewable and portable, then add the execution, communication,
quality, and evidence pieces your next adoption rung requires.
