/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 07289502fee98cadc5a36fd40f54bfb9)
...
interface __BaseEnv_Env {
	...
	INFERENCE_MODELS: "{\"models\":[],\"rate\":{\"version\":\"initial\",\"markupBps\":0}}";
	RESIDENTS_ENABLED: "false";
	...
	BILLING_ACCOUNTS: DurableObjectNamespace<import("./src/worker").BillingAccount>;
	CLI_DEVICES: DurableObjectNamespace<import("./src/worker").CliDevice>;
	INFERENCE_REQUESTS: DurableObjectNamespace<import("./src/worker").InferenceRequest>;
	RESIDENT_WORKSPACES: DurableObjectNamespace<import("./src/worker").ResidentWorkspace>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "GitHubUserGrant" | "BillingAccount" | "CliDevice" | "InferenceRequest" | "ResidentWorkspace";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "GITHUB_APP_SLUG" | "GITHUB_APP_ID" | "GITHUB_CLIENT_ID" | "FACTORY_AUTO_START_ACTOR_IDS" | "BILLING_ENABLED" | "STRIPE_LIVE_MODE" | "CLI_AUTH_ENABLED" | "INFERENCE_ENABLED" | "INFERENCE_MODELS" | "RESIDENTS_ENABLED" | "LOCAL_GITHUB_TOKEN" | "LOCAL_GITHUB_AUTH" | "LOCAL_GITHUB_ACCOUNTS" | "AGENTS_PLAN_SIGNING_KEY">> {}
}
